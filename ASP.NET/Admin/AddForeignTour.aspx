<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="AddForeignTour.aspx.cs" Inherits="ASP.NET.Admin.AddForeignTour" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainRight" runat="server">
    <table cellpadding="0" cellspacing="0" class="auto-style1" style="width: 100%" >
            ...
            <tr>
                <td style="width: 20%"><asp:Label ID="Label11" runat="server" Text="Quốc gia:" ForeColor="Red" Width="100%" ></asp:Label><br /></td>
                <td><asp:DropDownList ID="ddlPlace" runat="server" DataSourceID="SelectAllForeignTour" DataTextField="PlaceName" DataValueField="PlaceId"></asp:DropDownList></td>
            </tr>
            <tr>
