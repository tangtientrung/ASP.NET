...
namespace DTO
{
    public class TourDTO
    {
        ...
        public int TourPrice { get => _tourPrice; set => _tourPrice = value; }
        public string Status { get => _status; set => _status = value; }
        public TourDTO()
        {

        }
        public TourDTO(string tourId, string tourPhoto, string tourName, string tourDescription, int tourPrice,
